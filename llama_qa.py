...
### IMPORTANT CONFIGS
#ENTER Hugging face access token GOOGLE API KEY AND cx TOKEN after generating them
...
#GOOGLE API KEY AND cx TOKEN
cx = ''
api_key = ''

if cx=='' or api_key=='' or access_token=='':
    print("please enter necessary keys...and try again\n")
    exit()
